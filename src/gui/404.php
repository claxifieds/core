            ...
            <li>
                ...
                <form action="<?php echo osc_base_url(true); ?>" method="get" class="search">
                    ...
                    <fieldset class="main">
                        ...
                        <button type="submit"
                                class="ui-button ui-button-middle"><?php _e('Search', 'bender'); ?></button>
                    </fieldset>
                </form>
            </li>
            <li><?php _e("<strong>Look</strong> for it in the most popular categories.", 'bender'); ?>
                <div class="categories">
                    ...
                    <?php while (osc_has_categories()) { ?>
                        <h2><a class="category <?php echo osc_category_slug(); ?>"
                        ...
                        <?php if (osc_count_subcategories() > 0) { ?>
                            <?php while (osc_has_subcategories()) { ?>
                                <?php if (osc_category_total_items() > 0) { ?>
                                    <h3><a class="category <?php echo osc_category_slug(); ?>"
                                           href="<?php echo osc_search_category_url(); ?>"><?php echo osc_category_name(); ?></a>
