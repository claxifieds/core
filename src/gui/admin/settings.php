...
<?php if ((!defined('MULTISITE') || MULTISITE == 0) && !osc_get_preference('footer_link', 'bender') && !osc_get_preference('donation', 'bender')) { ?>
    <form name="_xclick" action="https://www.paypal.com/in/cgi-bin/webscr" method="post" class="nocsrf">
        ...
        <input type="hidden" name="custom"
               value="<?php echo osc_admin_render_theme_url('oc-content/themes/bender/admin/settings.php'); ?>&donation=successful&source=bender">
        <div id="flashmessage" class="flashmessage flashmessage-inline flashmessage-warning"
             style="color: #505050; display: block; ">
            <p><?php _e('I would like to contribute to the development of Osclass with a donation of', 'bender'); ?>
                ...
                </select><input type="submit" class="btn btn-mini" name="submit"
                                value="<?php echo osc_esc_html(__('Donate', 'bender')); ?>"></p>
        </div>
    </form>
<?php } ?>
...
<form action="<?php echo osc_admin_render_theme_url('oc-content/themes/bender/admin/settings.php'); ?>" method="post"
    ...
    <fieldset>
        <div class="form-horizontal">
            <div class="form-row">
                ...
                <div class="form-controls"><input type="text" class="xlarge" name="keyword_placeholder"
                                                  value="<?php echo osc_esc_html(osc_get_preference('keyword_placeholder', 'bender')); ?>">
                </div>
            </div>
            <div class="form-row">
            ...
            <?php if (!defined('MULTISITE') || MULTISITE == 0) { ?>
                <div class="form-row">
                    ...
                    <div class="form-controls">
                        <div class="form-label-checkbox"><input type="checkbox" name="footer_link"
                                                                value="1" <?php echo(osc_get_preference('footer_link', 'bender') ? 'checked' : ''); ?> > <?php _e('I want to help Osclass by linking to <a href="http://osclass.org/" target="_blank">osclass.org</a> from my site with the following text:', 'bender'); ?>
                        </div>
    ...
    <div class="form-row">
        ...
        <div class="form-controls">
            <p><?php _e('In this section you can configure your site to display ads and start generating revenue.', 'bender'); ?>
                <br/><?php _e('If you are using an online advertising platform, such as Google Adsense, copy and paste here the provided code for ads.', 'bender'); ?>
            </p>
        </div>
    </div>
    <fieldset>
        <div class="form-horizontal">
            <div class="form-row">
                ...
                <div class="form-controls">
                    <textarea style="height: 115px; width: 500px;"
                              name="header-728x90"><?php echo osc_esc_html(osc_get_preference('header-728x90', 'bender')); ?></textarea>
                    <br/><br/>
            ...
            <div class="form-row">
                ...
                <div class="form-controls">
                    <textarea style="height: 115px; width: 500px;"
                              name="homepage-728x90"><?php echo osc_esc_html(osc_get_preference('homepage-728x90', 'bender')); ?></textarea>
                    <br/><br/>
            ...
            <div class="form-row">
                ...
                <div class="form-controls">
                    <textarea style="height: 115px; width: 500px;"
                              name="search-results-top-728x90"><?php echo osc_esc_html(osc_get_preference('search-results-top-728x90', 'bender')); ?></textarea>
                    <br/><br/>
            ...
            <div class="form-row">
                ...
                <div class="form-controls">
                    <textarea style="height: 115px; width: 500px;"
                              name="search-results-middle-728x90"><?php echo osc_esc_html(osc_get_preference('search-results-middle-728x90', 'bender')); ?></textarea>
                    <br/><br/>
            ...
            <div class="form-row">
                ...
                <div class="form-controls">
                    <textarea style="height: 115px; width: 500px;"
                              name="sidebar-300x250"><?php echo osc_esc_html(osc_get_preference('sidebar-300x250', 'bender')); ?></textarea>
                    <br/><br/>
