    ...
    <div class="form-container form-horizontal">
        <div class="resp-wrapper">
            ...
            <form action="<?php echo osc_base_url(true); ?>" method="post">
                ...
                <div class="control-group">
                    <label class="control-label" for="new_password2"><?php _e('Repeat new password', 'bender'); ?>
                        *</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <div class="controls">
                        <button type="submit"
                                class="ui-button ui-button-middle ui-button-main"><?php _e("Update", 'bender'); ?></button>
                    </div>
                </div>
            </form>
        </div>
