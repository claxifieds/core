...
<div id="wrapper">
    <div id="container">
        <div id="header" class="installation">
            <h1 id="logo">
                <img src="<?php echo get_absolute_url(); ?>oc-includes/osclass/assets/images/osclass-logo.png"
                     alt="Osclass" title="Osclass"/>
            </h1>
                            ...
                            <div class="requirements_help">
                                ...
                                <ul>
                                    <?php foreach ($requirements as $k => $v) { ?>
                                        ...
                                        <?php } ?>
                                    <?php } ?>
                                    <li><a href="http://forums.osclass.org/"
                        ...
                        <ul>
                            <?php foreach ($requirements as $k => $v) { ?>
                                <li><?php echo $v['requirement']; ?> <img
                                            src="<?php echo get_absolute_url(); ?>oc-includes/osclass/assets/images/<?php echo $v['fn'] ? 'tick.png' : 'cross.png'; ?>"
                                            alt="" title=""/></li>
                            <?php } ?>
                        </ul>
